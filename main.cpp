...
void greetings(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning Master Nihil"<<endl;
        string phrase = "Good Morning Master Nihil";
        ...
        cout<< "Good Afternoon Master Nihil"<<endl;
        string phrase = "Good Afternoon Master Nihil";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening Master Nihil"<<endl;
        string phrase = "Good Evening Master Nihil";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    do
    {
        ...
        if(password=="nihil")
        {
            ...
            do{
                cout<<"\n<**********************************************************************************************>\n\n";
                cout<<endl<<"How can i help you Master Nihil...."<<endl<<endl;

                string phrase = "How can i help you Master Nihil";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                {
                    cout<<"Hello Master Nihil....."<<endl;
                    string phrase = "Hello Master Nihil";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"I'm a personal assistant created by Master Nihil !!!"<<endl;
                    string phrase = "I'm a personal assistant created by Master Nihil!!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
